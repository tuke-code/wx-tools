...
if(NOT EXISTS ${CMAKE_SOURCE_DIR}/3rd/${packet_name}/tab/gentab64.inc)
  execute_process(COMMAND ${CMAKE_COMMAND} -E copy_directory_if_different
                          ${CMAKE_SOURCE_DIR}/3rd/libcrc ${CMAKE_SOURCE_DIR}/3rd/${packet_name}/tab)
endif()

file(GLOB LIBCRC_H ${CMAKE_SOURCE_DIR}/3rd/${packet_name}/include/*.*)
file(GLOB LIBCRC_C ${CMAKE_SOURCE_DIR}/3rd/${packet_name}/src/*.*)

include_directories(${CMAKE_SOURCE_DIR}/3rd/${packet_name}/include)
add_library(libcrc STATIC ${LIBCRC_H} ${LIBCRC_C})
set_target_properties(libcrc PROPERTIES FOLDER "3rd")

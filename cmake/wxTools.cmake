...
function(wxt_make_zip target)
  if(WIN32)
    ...
    if(CMAKE_SIZEOF_VOID_P EQUAL 8)
      set(TAR_FILE_NAME ${lower_target}-${lower_system_name}-${WXT_GIT_TAG}-x64)
    else()
      set(TAR_FILE_NAME ${lower_target}-${lower_system_name}-${WXT_GIT_TAG}-x86)
    endif()
    add_custom_command(
      TARGET ${target}
      POST_BUILD
      COMMAND ${CMAKE_COMMAND} -E tar "cf" ${TAR_FILE_NAME}.zip "--format=zip" ${target}
      COMMAND "echo ${TAR_FILE_NAME} > ${WX_TOOLS_BINARY_DIR}/zip_name.txt"

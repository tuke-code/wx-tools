function(wxt_make_deb target packetName friendlyName version)
  ...
  add_custom_target(
    ${target}-deb
    COMMAND ${CMAKE_COMMAND} -E remove_directory {CMAKE_BINARY_DIR}/deb/${target} "||"
            ${CMAKE_COMMAND} -E true
    COMMAND ${CMAKE_COMMAND} -E copy_directory ${CMAKE_SOURCE_DIR}/.cmake/deb/app
            ${CMAKE_BINARY_DIR}/deb/${target} "||" ${CMAKE_COMMAND} -E true
    COMMAND ${CMAKE_COMMAND} -E copy_directory ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}
            ${CMAKE_BINARY_DIR}/deb/${target}/opt/${packetName}
